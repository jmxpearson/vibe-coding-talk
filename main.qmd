...
9. Repeat -- do not exit /tightloop -- until the user says you're on your own or the problem is solved.
...
## Result
- After using `/tightloop`, I found that CC was fighting a very low resting potential.
...
## More overthinking
Every time I asked Claude to implement the full model, it went in circles trying to check parameter values. I decided to ask the web interface to make a plan so that I could give that to CC as a guide.