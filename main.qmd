...
## Rick Rubin selected c.v. {.scrollable}

<div style="font-size: 0.4em;">
| \# | Title | Artist | Year | Type | Billboard Peak | US Certification | Grammy | Notes |
|---|-------|--------|------|------|---------------|-----------------|--------|-------|
| 1 | *Radio* | LL Cool J | 1985 | Album | #46 (200) | Gold | — | First major hip-hop LP on Def Jam |
| 2 | *Licensed to Ill* | Beastie Boys | 1986 | Album | **#1** (200) | 10× Platinum | — | First rap album to top Billboard 200 |
| 3 | "Walk This Way" | Run-DMC ft. Aerosmith | 1986 | Single | #4 (Hot 100) | 2× Platinum | — | Rubin produced; ~1B streams |
| 4 | *Reign in Blood* | Slayer | 1986 | Album | #94 (200) | Platinum | — | Defining thrash metal record |
| 5 | *The Razors Edge* | AC/DC | 1990 | Album | #2 (200) | 5× Platinum | — | "Thunderstruck" #5 Mainstream Rock |
| 6 | *Blood Sugar Sex Magik* | Red Hot Chili Peppers | 1991 | Album | #3 (200) | 7× Platinum | — | "Under the Bridge" #2 Hot 100 |
| 7 | *American Recordings* | Johnny Cash | 1994 | Album | #110 (200) | Gold | Best Contemporary Folk Album | Launched Cash's critical renaissance |
| 8 | *Wildflowers* | Tom Petty | 1994 | Album | #8 (200) | 2× Platinum | — | Widely regarded career-best |
| 9 | *Californication* | Red Hot Chili Peppers | 1999 | Album | #3 (200) | 5× Platinum | — | ~4B streams on Spotify |
| 10 | *Toxicity* | System of a Down | 2001 | Album | **#1** (200) | 4× Platinum | — | Title track #1 Mainstream Rock |
| 11 | *American IV: The Man Comes Around* | Johnny Cash | 2002 | Album | #22 (200) | Platinum | Best Male Country Vocal ("Hurt") | "Hurt" video won Grammy; ~700M streams |
| 12 | *Audioslave* | Audioslave | 2002 | Album | #7 (200) | 3× Platinum | — | "Like a Stone" #1 Mainstream Rock |
| 13 | *Meteora* | Linkin Park | 2003 | Album | **#1** (200) | 6× Platinum | — | 27 weeks at #1 on Rock charts |
| 14 | "99 Problems" | Jay-Z | 2003 | Single | #8 (Hot 100) | Platinum | Best Rap Solo Performance | Rubin produced; ~1B streams |
| 15 | *Vol. 3: The Subliminal Verses* | Slipknot | 2004 | Album | #2 (200) | 2× Platinum | Best Metal Performance ("Before I Forget") | — |
| 16 | *Stadium Arcadium* | Red Hot Chili Peppers | 2006 | Album | **#1** (200) | 3× Platinum | Best Rock Album | 28 Grammy nominations across career for Rubin-produced RHCP |
| 17 | *Weezer (Red Album)* | Weezer | 2008 | Album | #4 (200) | Gold | — | — |
| 18 | *Death Magnetic* | Metallica | 2008 | Album | **#1** (200) | Platinum | — | #1 in 34 countries |
| 19 | *13* | Black Sabbath | 2013 | Album | **#1** (200) | Gold | Best Metal Performance ("God Is Dead?") | Band's first #1 album |
| 20 | *Yeezus* | Kanye West | 2013 | Album | **#1** (200) | Platinum | — | 9 Grammy nominations for the album |
</div>
...
![From [_Welcome to Gas Town_](https://steve-yegge.medium.com/welcome-to-gas-town-4f25ee16dd04)](https://miro.medium.com/v2/resize:fit:1400/format:webp/1*3iC6cilfUdvndZUVRELmBA.jpeg)
...
Claude Code is as good as the best undergrads I've ever had. Capable of tremendous things, but you'd best check up on it.
:::
...
It's hard to _teach_ these tools in any straighforward way.

. . .

::: {.callout-note}
## The jagged frontier
Coined by [Dell'Acqua _et al._ (2023)](https://www.hbs.edu/ris/Publication%20Files/24-013_d9b45b68-9e74-42d6-a1c6-c72fb70c7282.pdf), the jagged frontier refers to the limits current model capabilities. "Jagged" because it's difficult to reason about how a model will perform on a new task based on past experience. Models can be a surprising mix of skilled and incompetent on tasks of similar human difficulty.
:::

. . .

The best we have at this point are anecdote and folk wisdom (that rapidly grow obsolete).
...
Like papers, grants, etc., automated coding tools require managing cognitive debt.
...
- CC can search the web, edit your files, run tests, interface with GitHub, install packages, etc.
...
::: {.callout-warning}
These tools are powerful, but you are giving a program license to rewrite your code.

Using version control, good tooling (`conda/mamba/uv`), and testing (where appropriate) are the _absolute minimum_.
:::
...
![](https://swiss-ipg.com/media/k2/items/cache/d197c421d422f5cbf569ea13f09ef700_L.jpg)